...
13. [Рендеринг и Skia](#13-рендеринг-и-skia)
14. [Структура проекта](#14-структура-проекта)
15. [Нефункциональные требования и риски](#15-нефункциональные-требования-и-риски)
16. [Процесс разработки](#16-процесс-разработки)
