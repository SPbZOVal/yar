...
Доменная модель строго типизирована (TypeScript strict). Все агрегаты ниже — это данные, которыми оперируют чистые модули из главы [«Архитектура системы»](02-architecture.md#5-архитектура-домена). Обзорная схема связей собрана в [§7.8](#78-сводная-диаграмма-связей-доменной-модели).
