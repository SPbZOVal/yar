...
сгенерированному уровню с ветвящимися маршрутами и сражаешься, разыгрывая карты
против монстров и боссов.

Каждый забег уникален, а каждая смерть — не конец, а ступенька: карты и
снаряжение, найденные в боях и сундуках, остаются в твоей коллекции и делают
следующий заход сильнее. Никаких микротранзакций и доната — только ты, колода и
удача сида.
...
|  Карта уровня  |  Бой  |  Сбор колоды  |
|:-------------:|:-----:|:-------------:|
| _скоро_ | _скоро_ | _скоро_ |

## ✨ Чем цепляет

- **🗺 Уровень — ветвящаяся карта.** Никаких линейных коридоров: каждый уровень —
  это карта локаций с развилками. Сам выбираешь, в каком порядке идти между боями,
  сундуками, загадками и боссами — порядок прохождения нелинейный.
- **🃏 Карты с характером.** Постоянные карты — твой костяк, они возвращаются в
  колоду каждый бой. Одноразовые карты бьют один раз и сгорают — приберегай их
...
2. **Проложи маршрут.** Тапни по доступной локации на карте, чтобы перейти к ней:
...
4. **Собирай добычу.** За победы и из сундуков падают новые карты и снаряжение.
   Постоянные карты и снаряжение пополняют коллекцию для будущих забегов, а
   одноразовые карты усиливают тебя прямо на текущем уровне.
...
**Управление.** На карте уровня — тап по доступной локации, чтобы перейти к ней. В
бою — перетаскивай карты на цель, чтобы разыграть их, а кнопка «Завершить ход»
передаёт ход врагам.

> 💡 **Совет.** Намерения врагов видны заранее — выставляй блок против сильных
> ударов и держи одноразовые карты на крайний случай.
